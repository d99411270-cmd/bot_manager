...
Slice H + автооффер прайса / 200 л морса закоммичены локально, **не** на Beget. Production `@Stokozavr_manager_bot` всё ещё `1b5169e`. После явного пуш/деплоя проверить живой 679025492: «Всё»/напитки без фразы про прайс; «морс цена за литр» = 106.67; «200 литров» = 33/34 уп, не stub. Осталось: живой amoCRM, name-frequency, handoff adapter в стенде.
